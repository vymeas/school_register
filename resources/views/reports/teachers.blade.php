...
.t-tbl th{background:var(--bg-table-header,#f9fafb);font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:var(--text-muted,#64748b);padding:10px 14px;text-align:left;border-bottom:2px solid var(--border-color,#e2e8f0);cursor:pointer;user-select:none;white-space:nowrap}
.t-tbl td{padding:10px 14px;font-size:13px;color:var(--text-primary,#1c2434);border-bottom:1px solid var(--border-color,#e2e8f0)}
.t-tbl tbody tr:hover{background:rgba(99,102,241,.06)}
.t-tbl tfoot td{padding:10px 14px;font-weight:800;background:rgba(99,102,241,.08);border-top:2px solid var(--border-color,#e2e8f0)}
...
.t-srch{display:flex;align-items:center;gap:8px;border:1px solid var(--border-color,#e2e8f0);border-radius:8px;background:var(--bg-input,#ffffff);padding:6px 12px;max-width:260px}
.t-srch input{border:none;background:transparent;color:var(--text-primary,#1c2434);font-size:13px;outline:none;width:100%}
</style>
...
<div class="card" style="width:100%;height:100%;">
  ...
  <div style="display:flex;align-items:center;gap:10px;padding:10px 16px;border-bottom:1px solid var(--border-color,#e2e8f0);flex-wrap:wrap;">
    <div class="t-srch"><span style="color:var(--text-muted,#64748b);"><i data-lucide="search" style="width:14px;height:14px;"></i></span><input id="tsearch" placeholder="Search teacher, email…" oninput="filterT()"></div>
